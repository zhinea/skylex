...
func TestAgentService_RegisterAgent_RequiresToken(t *testing.T) {
	...
	svc := NewAgentService(&Config{Agent: AgentConfig{}}, db.NewNodeRepository(conn, log), db.NewAgentCommandRepository(conn, log), db.NewAgentTokenRepository(conn, log), log)
...
func TestAgentService_RegisterAgent_ValidToken(t *testing.T) {
	...
	svc := NewAgentService(&Config{Agent: AgentConfig{}}, db.NewNodeRepository(conn, log), db.NewAgentCommandRepository(conn, log), agentTokens, log)
...
func TestAgentService_RegisterAgent_DevTokenFallback(t *testing.T) {
	...
	svc := NewAgentService(&Config{Agent: AgentConfig{AgentToken: "dev-token"}}, db.NewNodeRepository(conn, log), db.NewAgentCommandRepository(conn, log), db.NewAgentTokenRepository(conn, log), log)
