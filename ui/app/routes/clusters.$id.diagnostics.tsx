...
import { levelColor, statusDetailColor } from "~/components/cluster/ClusterHelpers";
...
export default function ClusterDiagnosticsPage() {
  const { clusterId, nodes, onlineNodes, totalNodes, progressPct } = useClusterContext();
  ...
  const { logs, state: logStreamState } = useCommandLogStream({ clusterId, filter: logFilter });
