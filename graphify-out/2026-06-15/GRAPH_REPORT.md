...
2. `Backup` - 30 edges
3. `Context` - 30 edges
4. `BackupSchedule` - 27 edges
5. `file_skylex_v1_backup_proto_rawDescGZIP()` - 27 edges
6. `AuthServiceClient` - 27 edges
7. `ClusterServiceClient` - 27 edges
8. `file_skylex_v1_cluster_proto_rawDescGZIP()` - 25 edges
9. `StorageConfig` - 25 edges
10. `Context` - 24 edges
...
## Communities (135 total, 54 thin omitted)
...
Cohesion: 0.10
Nodes (23): AgentConfig, AuthConfig, BackupConfig, DatabaseConfig, EtcdConfig, Duration, LoggingConfig, PostgresConfig (+15 more)
